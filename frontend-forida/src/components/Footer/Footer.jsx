...
const Footer = () => {
  return (
    <div>
            ...
            >
              ...
              <div className='text-white '>
                   <ul className='max-w-160 mx-auto list-none flex items-center justify-center gap-y-2  flex-wrap mb-10'>
                        <li className='text-[15px] font-poppins font-normal px-3.75'>Help</li>
                        <li className='text-[15px] font-poppins font-normal px-3.75'>Contact Us</li>
                        <li className='text-[15px] font-poppins font-normal px-3.75'>Shops</li>
                        <li className='text-[15px] font-poppins font-normal px-3.75'>My Accounts</li>
                        <li className='text-[15px] font-poppins font-normal px-3.75'>Orders</li>
                        <li className='text-[15px] font-poppins font-normal px-3.75'>Returns</li>
                        <li className='text-[15px] font-poppins font-normal px-3.75'>Gift Voucher</li>
                        <li className='text-[15px] font-poppins font-normal px-3.75'>Company</li>
                        <li className='text-[15px] font-poppins font-normal px-3.75'>About Us</li>
                        <li className='text-[15px] font-poppins font-normal px-3.75'>FAQs</li>
                   </ul>
        ...
        <div className='p-8.5'>
            <p className='text-center text-[14px] text-[#333] font-normal'>Copyright © 2026 <span className='text-[#f73b08]'>FieldThemes</span>. All Right Reserved</p>
        </div>
    </div>
  )
}
